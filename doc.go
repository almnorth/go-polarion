...
The client provides the following features:
  ...
  - Work Item Attachments: Upload, download, and manage file attachments
  - Work Item Approvals: Manage approval workflows and statuses
  - Work Item Work Records: Track time spent on work items
  - Work Item Relationships: Manage relationships and workflow actions
