...
- ✅ **Comprehensive Coverage** - Work items, projects, users, enumerations, and more
- ✅ **Type-Safe Custom Fields** - Strongly typed custom work item types
- ✅ **Code Generation** - Automatic generation of custom work item types
...
Full CRUD operations, querying, custom fields, and relationships:
...
Automatically generate type-safe structs from your Polarion configuration:
...
Access Polarion instance metadata and manage custom field configurations (Polarion >= 2512):
...
- **[Configuration Guide](docs/CONFIGURATION.md)** - Client configuration options and best practices
- **[Custom Work Items](docs/CUSTOM-WORKITEMS.md)** - Type-safe custom work item types
- **[Code Generation](docs/CODEGEN.md)** - Automatic code generation tool
